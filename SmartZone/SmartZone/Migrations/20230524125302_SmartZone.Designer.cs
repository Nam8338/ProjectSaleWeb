...
namespace SmartZone.Migrations
{
    ...
    [Migration("20230524125302_SmartZone")]
    partial class SmartZone
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartZone.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.Attribute", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.AttributePrice", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.ImportDetail", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.ImportTicket", b =>
                {
                    b.Property<int>("TicketId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SmartZone.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SmartZone.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartZone.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("SmartZone.Models.TransactStatus", b =>
                {
                    b.Property<int>("TransactionStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SmartZone.Models.Account", b =>
                {
                    b.HasOne("SmartZone.Models.Role", "Role")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("SmartZone.Models.AttributePrice", b =>
                {
                    b.HasOne("SmartZone.Models.Attribute", "Attribute")
                        .WithMany("AttributePrices")
                        .HasForeignKey("AttributeId")
                        .HasConstraintName("FK_AttributePrices_Attribute");

                    b.HasOne("SmartZone.Models.Product", "Product")
                        .WithMany("AttributePrices")
            ...
            modelBuilder.Entity("SmartZone.Models.ImportDetail", b =>
                {
                    ...
                    b.HasOne("SmartZone.Models.ImportTicket", "Ticket")
                        .WithMany("ImportDetails")
            ...
            modelBuilder.Entity("SmartZone.Models.ImportTicket", b =>
                {
                    b.HasOne("SmartZone.Models.Account", "User")
            ...
            modelBuilder.Entity("SmartZone.Models.Order", b =>
                {
                    b.HasOne("SmartZone.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Order_Customers");

                    b.HasOne("SmartZone.Models.TransactStatus", "TransactionStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SmartZone.Models.OrderDetail", b =>
                {
                    b.HasOne("SmartZone.Models.Order", "Order")
            ...
            modelBuilder.Entity("SmartZone.Models.Product", b =>
                {
                    b.HasOne("SmartZone.Models.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId")
                        .HasConstraintName("FK_Product_Brand");

                    b.HasOne("SmartZone.Models.Category", "Cate")
                        .WithMany("Products")
