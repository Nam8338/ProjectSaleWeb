...
namespace Admin.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public LoginController(MyDbContext context, INotyfService notyfService)
        {
        ...
        public async Task<IActionResult> AdLogin(LoginViewModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("Index", "Home"); // sau khi tài khoản mật khẩu đúng các kiểu r thì get từ session ra xong direct về index của Home admin
